...
/**
 * Delta Force gallery shots — filenames include primary SEO keywords
 * (rust, cheats, esp, aimbot, wallhack, survival, etc.)
 */
const KEYWORD_ASSETS = [
	{ file: 'the-delta-force-cheats-hero.webp', url: `${CDN_GALLERY}/rust-gameplay-screenshots-2024_s2qs.1400.jpg` },
	{ file: 'delta-force-cheats-cover.webp', url: `${CDN_B}/rust-survival-chapter-5-season-1-screenshot-a-1920x_xkzh.1400.jpg` },
	{ file: 'rust-loadout-builder.webp', url: `${CDN_B}/rust-survival-chapter-5-season-1-screenshot-b-1920x_8z8k.1400.jpg` },
	{ file: 'the-delta-force-cheats-aimbot-combat.webp', url: `${CDN_B}/rust-survival-chapter-5-season-1-screenshot-c-1920x_vu5r.1400.jpg` },
	{ file: 'rust-pack-fight.webp', url: `${CDN_B}/rust-survival-chapter-5-season-1-screenshot-d-1920x_mzsk.1400.jpg` },
	{ file: 'the-delta-force-cheats-esp-wallhack.webp', url: `${CDN_B}/rust-survival-chapter-5-season-1-train-1920x1080-a1_1nkx.1400.jpg` },
	{ file: 'delta-force-cheats-package.webp', url: 'https://sm.ign.com/t/ign_latam/gallery/f/rust-c/rust-chapter-5-underground-images_5h3j.1400.jpg' },
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'the-delta-force-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		if (asset.file === 'the-delta-force-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`Done — attempted ${KEYWORD_ASSETS.length} keyword-named Delta Force images.`);
