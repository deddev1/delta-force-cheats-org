...
async function main() {
	...
	en.home = {
		...
		aboutP1:
			'Delta Force Cheats delivers undetected wallhacks, precision aim assistance, and tactical radar for Delta Force on PC. Every license includes ESP with bone tracking, customizable soft aim, and real-time 2D radar overlay—automatically rebuilt via ACE architecture following game updates. Always verify current status before entering matchmaking.',
		aboutP2Before: 'New users: start with the',
		aboutPillar: 'Delta Force Cheats overview',
		aboutP2Mid: ', browse the ',
		aboutEsp: 'ESP configuration guide',
		aboutP2Review: ', review ',
		aboutAimbot: 'aimbot keybinds',
		aboutP2Or: ', or check ',
		aboutUndetected: 'live undetected status',
		aboutP2After: ' while evaluating providers.',
		volumeLabel: 'Volume',
