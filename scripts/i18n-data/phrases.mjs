...
const KW = {
	...
	cheats: 'delta force cheats',
	hack: 'delta force cheat',
	esp: 'Delta Force ESP',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'Delta Force Aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Delta Force Cheats', undetected: 'indetectables', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'Contacta support@deltaforcecheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Delta Force Cheats', undetected: 'indétectables', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'Contactez support@deltaforcecheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Delta Force Cheats kaufen', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Delta Force Cheats', undetected: 'indetectáveis', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'Contacte support@deltaforcecheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Delta Force Cheats', undetected: 'indetectable', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'Contatta support@deltaforcecheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'Delta Force Cheats kopen', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Delta Force Cheats satın al', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'Destek ve yasal sorular için support@deltaforcecheats.org.',
	},
	ar: {
		buy: 'اشترِ Delta Force Cheats', undetected: 'غير مكتشف', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Delta Force Cheatsを購入', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'サポート・法務: support@deltaforcecheats.org',
	},
	ko: {
		buy: 'Delta Force Cheats 구매', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => '지원 및 법무: support@deltaforcecheats.org',
	},
	zh: {
		buy: '购买 Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => '支持与法务：support@deltaforcecheats.org',
	},
	hi: {
		buy: 'Delta Force Cheats खरीदें', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'सहायता: support@deltaforcecheats.org',
	},
	id: {
		buy: 'Beli Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Delta Force Cheats', undetected: 'undetected', maps: 'maps, objectives, and extraction points',
		...
		legal: () => 'support@deltaforcecheats.org för support och juridik.',
	},
};
