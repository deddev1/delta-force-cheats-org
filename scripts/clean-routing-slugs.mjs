...
// Fix ace-bypass slugs that got double-replaced
content = content.replace(/ace-bypass-bypass/g, 'ace-bypass');
content = content.replace(/ace-bypass-trucos-delta-force/g, 'ace-bypass-trucos-delta-force');
