 ...
 * `lastmod` reflects when ACE page's content actually changed — do NOT reset all
...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	...
	/** Money URL for "delta force cheats" */
	...
	ace: { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-25' },
	'delta-force-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-24' },
	'delta-force-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-24' },
